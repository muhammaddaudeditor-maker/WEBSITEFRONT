...
export default function ContactPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const contactInfoRes = await fetch('https://api.daudportfolio.cloud/api/contact/info/');
        const reasonsRes = await fetch('https://api.daudportfolio.cloud/api/contact/reasons/');
        const heroRes = await fetch('https://api.daudportfolio.cloud/api/contact/hero/contact/');
